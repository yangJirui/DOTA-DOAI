...
def parse_args():
    ...
    parser.add_argument('--eval_imgs', dest='eval_imgs',
                        ...
                        default='/home/yjr/DataSet/VOC/VOCall/voc2007test/VOCdevkit/VOC2007/JPEGImages', type=str)
    parser.add_argument('--annotation_dir', dest='test_annotation_dir',
                        help='the dir save annotations',
                        default='/home/yjr/DataSet/VOC/VOCall/voc2007test/VOCdevkit/VOC2007/Annotations', type=str)
