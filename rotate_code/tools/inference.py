...
if __name__ == "__main__":
    ...
    file_paths = get_file_paths_recursive('/home/yjr/DataSet/Dota/test/images/images', '.png')
    if cfgs.USE_CONCAT:
        ...
        det_net = build_whole_network.DetectionNetwork(base_network_name=cfgs.NET_NAME,
                                                       is_training=False)
    inference(det_net, file_paths, '/home/yjr/PycharmProjects/DotaCodes/semi_rotate/tools/demos', 800, 800,
