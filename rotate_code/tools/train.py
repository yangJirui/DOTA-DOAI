...
def train():
    ...
    gtboxes_rotate_in_img = show_box_in_tensor.draw_box_with_color_rotate(img_batch=img_batch,
                                                                          boxes=r_gtboxes_and_label[:, :-1],
                                                                          text=tf.shape(r_gtboxes_and_label)[0])
    ...
    tf.summary.image('Compare/gtboxes_h', gtboxes_in_img)
    tf.summary.image('Compare/gtboxes_R', gtboxes_rotate_in_img)
